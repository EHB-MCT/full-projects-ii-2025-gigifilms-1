...
async function changeStroke() {
  ...
  record = await pb.collection(localStorage.getItem('userType')).getOne(localStorage.getItem('userID'));
  console.log(record);
...
function prefillElements() {
  let elementsToFill = document.querySelectorAll('.container input');
  for (const i of elementsToFill) {
    i.value = record[i.getAttribute('id')];
  }
  elementsToFill = document.querySelectorAll('.container select');
  for (const i of elementsToFill) {
    i.value = record[i.getAttribute('id')];
  }
}
...
function changeHTMLAcc() {
  ...
  element.innerHTML = `<h1>Account</h1>
        <div class="flex column gap-10">
          <label aria-label="name" for="name">Full name</label>
...
function changeHTMLPer() {
  ...
  element.innerHTML = `<h1>Personal info</h1>
            <div class="flex column gap-10">
              <label aria-label="date_of_birth" for="Date of birth">Date of birth</label>
              <input type="datetime" id="date_of_birth" />
            </div>
            <div class="flex column gap-10">
              ...
              <select id="gender">
                ...
                <option aria-label="prefer_not_to_say" value="Prefer">Prefer not to say</option>
              </select>
            </div>
            <div class="flex column gap-10">
...
function changeHTMLPar() {
  ...
  element.innerHTML = `<h1>Parental info (-18)</h1>
            <div class="flex column gap-10">
              <label aria-label="name parent" for="Name parent/guardian">Name parent/guardian</label>
              <input type="text" id="parent_name" />
            </div>
            <div class="flex column gap-10">
              <label aria-label="parent_email" for="Name parent/guardian">E-mail parent/guardian</label>
              <input type="email" id="parent_email" />
            </div>
            <div class="flex column gap-10">
              <label aria-label="parent_phone" for="phone">Telephone number parent/guardian</label>
              <input type="tel" id="parent_phone" pattern="[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}" />
            </div>
          </div>
          <div class="buttons flex row gap-20">
            <button aria-label="update">Update</button>
...
function changeHTMLVid() {
  ...
  element.innerHTML = `<h1>Photo’s & video’s</h1>
            <div class="flex column gap-10">
              <label><h2>Short description</h2></label>
              <textarea id="biotext" rows="10" ></textarea>
            </div>
